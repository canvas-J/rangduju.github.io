    ...
    render(){
        return (
            <div className="about">
                ...
                {/* <div className="distance"><iframe className="airtable-embed" src="https://airtable.com/embed/shrRfme06EYHbf6qB?backgroundColor=yellowLight&viewControls=on" frameborder="0" onmousewheel="" width="100%" height="533" style={{background:'transparent',border:'1px solid #ccc'}}></iframe></div> */}
