// miniprogram/pages/uploadPageSecond/uploadPageSecond.js
...
var positions = app.globalData.positions2
var uploadRes = app.globalData.uploadRes2
var loading = app.globalData.loading2
var imgChoose = app.globalData.imgChoose2
var order_num = 0
...
Page({
  ...
  onLoad: function () {
    positions = app.globalData.positions2
    uploadRes = app.globalData.uploadRes2
    loading = app.globalData.loading2
    imgChoose = app.globalData.imgChoose2
    if (!wx.cloud) {
      wx.redirectTo({
  ...
  finish: function () {
    this.updateOrderNum()
    app.globalData.positions = []
    app.globalData.uploadRes = []
    app.globalData.loading = []
    app.globalData.imgChoose = []
    app.globalData.positions2 = []
    app.globalData.uploadRes2 = []
    app.globalData.loading2 = []
    app.globalData.imgChoose2 = []
    wx.navigateBack({
      delta: 2
    })
  },
  ...
  updateOrderNum: function() {
    wx.cloud.database().collection('order_num').add({
      data: {
       invCode : app.globalData.inCode,
        order_num: this.data.order_num
      },
