...
export default class Index extends Taro.Component {
  ...
  render() {
    ...
    return <View className="page page-index">
        <View className="logo">
          <Image src={bgImg} className="img" mode="widthFix" />
        </View>
        <View className="page-title">让渡居</View>
        <View className="module-list">
          {list.map((item, index) => <View className="module-list__item" key={index} data-id={item.id} data-name={item.title} data-list={item.subpages} onClick={this.gotoPanel}>
